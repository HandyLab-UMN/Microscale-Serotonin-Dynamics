...
The numerical simulations were completed in Julia and can be found in the subfolder 'run-numerical-simulations'. The file run_simuation_2D.jl contains the main numerical algorithm (written by M. Pelz, edited by G. Handy). 
